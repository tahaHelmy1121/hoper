...
class EditAddressView extends StatefulWidget {
  ...
  String address_address_1;
  String address_address_2;
  String address_mobile;

  EditAddressView(
      {super.key,
      required this.address_address_1,
      required this.address_address_2,
      required this.address_email,
      required this.address_first_name,
      required this.address_mobile});
                      ...
                      children: [
                        ...
                        SizedBox(
                            ...
                            child: AppTextFormField(
                              ...
                              //    pIcon: pIcon,
                              hintText:
                                  "${widget.address_first_name}", //=>address_first_name
                              validator: (value) {
                        ...
                        SizedBox(
                            ...
                            child: AppTextFormField(
                              controller:
                                  context.watch<AddressCubit>().address_email,
                              hentStyle: style1Font12Weight500Heint,
                              //   suffixIcon: icon,
                              //    pIcon: pIcon,
                              hintText: "${widget.address_email}", //=>address_first_name
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return null;
                                }
                        ...
                        SizedBox(
                            ...
                            child: AppTextFormField(
                              controller:
                                  context.watch<AddressCubit>().address_mobile,
                              hentStyle: style1Font12Weight500Heint,
                              //   suffixIcon: icon,
                              //    pIcon: pIcon,
                              hintText: "${widget.address_mobile}", //=>address_first_name
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return null;
                                }
                          ...
                          children: [
                            SizedBox(
                                ...
                                child: AppTextFormField(
                                  ...
                                  //   suffixIcon: icon,
                                  //    pIcon: pIcon,
                                  hintText: "${widget.address_address_2}",
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return null;
                                    }
                            ...
                            SizedBox(
                                ...
                                child: AppTextFormField(
                                  ...
                                  //   suffixIcon: icon,
                                  //    pIcon: pIcon,
                                  hintText: " ${widget.address_address_1}",
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return null;
                                    }
                        ...
                        drewCustomButton(
                            ...
                            on: () {
                              context
                                  .read<AddressCubit>()
                                  .editAddressFromRepo(context: context);
